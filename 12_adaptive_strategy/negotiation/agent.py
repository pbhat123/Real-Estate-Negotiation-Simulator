...
def submit_decision(action: str, price: int, tool_context: ToolContext) -> dict:
    """Submits the seller's decision for this round.
    Args:
...
def _extract_price(text: str) -> int | None:
    """Extracts the LAST plausible price from free text."""
...
def _accumulate_memory_and_check(callback_context: CallbackContext):
    ...
    1. Checks for ACCEPT → escalate.
    2. Extracts prices and compute concession metrics.
    3. Appends structured entry to negotiation_memory.
    """
